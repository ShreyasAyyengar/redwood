...
export default function UserEditor() {
  ...
  return (
    <div className="rounded-lg bg-neutral-900 p-3">
      ...
      <div className="mb-6 rounded-lg border border-white/5 bg-zinc-950/50 p-4">
      ...
      <div className="overflow-hidden rounded-lg border border-white/5 bg-zinc-950/50">
        <Table>
          <TableHeader className="bg-zinc-900/50">
            <TableRow className="border-white/5 hover:bg-transparent">
              <TableHead className="w-[300px] font-semibold text-zinc-400">Email</TableHead>
              <TableHead className="font-semibold text-zinc-400">Role</TableHead>
              <TableHead className="px-6 text-right font-semibold text-zinc-400">Actions</TableHead>
            </TableRow>
          </TableHeader>
          <TableBody>
            {isLoading ? (
              ...
              users.map((user) => (
                <TableRow key={user.email} className="border-white/5 transition-colors hover:bg-white/[0.02]">
                  <TableCell className="py-4 font-medium text-zinc-200">{user.email}</TableCell>
                      ...
                      <DialogContent className="border-white/10 bg-zinc-950 text-zinc-100 sm:max-w-md">
                        <DialogHeader>
                          ...
                          <DialogDescription className="text-zinc-400">
                            This will permanently remove <span className="font-semibold text-zinc-200">{user.email}</span> from the system. This
