...
export default function MainPage() {
  ...
  return (
    <>
      ...
      <div className="flex h-screen flex-col p-4 font-sans text-white xl:hidden">
      ...
      <div className="hidden h-screen flex-col items-center justify-center font-sans text-white xl:flex">
