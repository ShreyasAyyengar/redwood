...
export default function ResolutionField({ existingValue }: { existingValue?: string }) {
  ...
  const [resolving, setResolving] = useState(Boolean(existingValue ?? field.state.value?.comment));
