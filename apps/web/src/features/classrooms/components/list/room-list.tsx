...
import { getActiveFilterCount, roomMatchesActiveFilters, useActiveFiltersStore } from "../../model/active-filters";
import type { ClassroomSummary } from "../../model/classroom-types";
import RoomCard from "./room-card";

export default function RoomList({ data }: { data: ClassroomSummary[] }) {
