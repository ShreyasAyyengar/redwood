...
export default function AvailabilityCell({ row }: { row: Row<ClassroomSummary> }) {
...
function AvailabilityDialog({ room, children }: { room: Classroom; children: React.ReactNode }) {
  return (
    <Dialog>
