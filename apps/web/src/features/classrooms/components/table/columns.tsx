...
export const columns: ColumnDef<ClassroomSummary, any>[] = [
  ...
  columnHelper.accessor("displayName", {
    ...
    sortFn: (rowA, rowB) => rowA.original.displayName.localeCompare(rowB.original.displayName),
  }),
  ...
  columnHelper.accessor("openTasksCount", {
    ...
    sortFn: (rowA, rowB) => rowA.original.openTasksCount - rowB.original.openTasksCount,
  }),
];
