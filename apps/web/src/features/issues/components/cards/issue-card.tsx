...
export const IssueCard = ({
  ...
  const reportedDateDisplay: DateTimeDisplay = getDateTimeDisplay(new Date(issue.issue.reportedAt));
  const resolutionDateDisplay: DateTimeDisplay | undefined = issue.resolution && getDateTimeDisplay(new Date(issue.resolution.resolvedAt));
  const editedDateDisplay: DateTimeDisplay | undefined = issue.edited && getDateTimeDisplay(new Date(issue.edited.editDate));
    ...
    >
      ...
      <div className="flex items-start gap-3">
        <div className="mt-0.5">
          <IssueStatusIcon issue={issue} className="size-5" />
        </div>
