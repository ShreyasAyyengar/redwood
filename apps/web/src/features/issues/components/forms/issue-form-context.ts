...
export type { IssueFormValues } from "../../model/issue-form-schema";
...
export type IssueFormBodyApi = {
  AppField: ComponentType<{
    name: "cruzfixId" | "description" | "onHold" | "reportedAt" | "reportedBy" | "resolution" | "sodId" | "supervisorNeeded" | "urgent";
