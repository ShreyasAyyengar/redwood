...
export function IssueListDialog({
  ...
  const classrooms = useQuery(api.core.classrooms.service.getClassroomLookup, foreignView ? {} : "skip");
                  ...
                  >
                    <IssueDialog roomId={issue.classroomId} existingIssue={issue}>
                      <IssueCard
                        ...
                        classroomName={classrooms?.find((classroom) => classroom._id === issue.classroomId)?.displayName}
                      />
                    </IssueDialog>
                  </div>
                );
